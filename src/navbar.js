...
hamburger.addEventListener("click", () => {
  if (!menuOpen) {
    ...
    gsap.to(topBar, { rotation: 45, y: 10, backgroundColor: "#fff", duration: 0.3 });
    gsap.to(bottomBar, { rotation: -45, y: -8, backgroundColor: "#fff", duration: 0.3 });
    ...
    gsap.to(topBar, { rotation: 0, y: 0, backgroundColor: "#333", duration: 0.3 });
    gsap.to(bottomBar, { rotation: 0, y: 0, backgroundColor: "#333", duration: 0.3 });
